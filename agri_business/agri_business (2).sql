...
--
-- Host: localhost
-- Generation Time: Oct 06, 2021 at 07:58 AM
...
(9, 'Anusha', 9620180079, 'anusha1996@gmail.com', 'Last cross ayyappa nagar sirsi', 'admin', '123456', '2019-05-02');
...
(16, 'VISHWA', 9620180073, 'anusha@gmail.com', 'DWDGF', 'AMRIT', '123456', '2019-06-20'),
(17, 'Asif N k', 9743320840, 'asif@gmail.com', 'dwd', 'mak123', '123456', '2021-08-09');
...
CREATE TABLE IF NOT EXISTS `dealers_details` (
...
CREATE TABLE IF NOT EXISTS `dealers_purchase_details` (
  `dpd_id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `product_cart_details` (
