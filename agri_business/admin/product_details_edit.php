...
<!--                        <small>Examples of various form controls.</small>-->
         ...
         <?php
          ...
          ?>
                    ...
                    <form name="formID" id="formID" action="product_details_update.php" method="post" enctype="multipart/form-data" onsubmit="return ValidateForm()">
...
<!--                            <input type="text" class="form-control" name="dd_id" id="dd_id" value="<?php echo $row["dd_id"];?>" >-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="pd_name" id="pd_name" value="<?php echo $row["pd_name"];?>">
                        ...
                        <div class="form-group">
                            ...
                            <img src="photos/<?php echo $row["pd_image1"];?>" width="100" height="100">
                        ...
                        <div class="form-group">
                            ...
                            <img src="photos/<?php echo $row["pd_image2"];?>" width="100" height="100">
