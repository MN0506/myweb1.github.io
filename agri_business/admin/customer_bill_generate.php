...
$row=$result->fetch_assoc();
    ...
    $pdf->Image('../assets/img/logo.png',5,5,0);// logo of your company
...
//    $pdf->Cell(90 ,5,'state',0,1);
    $pdf->Cell(10 ,5,'',0,0);
    $pdf->Cell(90 ,5,'Mob : '.$row["cd_contact"],0,1);
//    $pdf->Cell(10 ,5,'',0,0);
...
while($row1=$result1->fetch_assoc())
{
    ...
    $pdf->Cell(25 ,10,$row1['pcd_unitprice'],1,0,'R');
    $pdf->Cell(20 ,10,$row1['sd_discount'],1,0,'R');
    $pdf->Cell(15 ,10,$row1['pcd_quantity'],1,0,'C');
    $pdf->SetFont('Arial','B',12);
    $pdf->Cell(29 ,10,$row1['pcd_total'],1,1,'R');//end of line
}
    //summary
//    $pdf->Cell(125 ,10,'',0,0);
    $pdf->SetFont('Arial','B',12);
