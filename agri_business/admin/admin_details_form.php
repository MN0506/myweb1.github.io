                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="hpanel">
                                ...
                                <div class="panel-body">
                    <form name="formID" id="formID" action="admin_details_insert.php" method="post" enctype="multipart/form-data" onsubmit="return ValidateForm()">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="ad_address"  id="ad_address" class="form-control"></textarea>
                            <span id="ad_address_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">CONTACT NO</label>
                            <input type="text" class="form-control" name="ad_contact" id="ad_contact">
                            <span id="ad_contact_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">EMAIL ID</label>
                            <input type="text" name="ad_email_id" class="form-control" id="ad_email_id">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ad_username" class="form-control" id="ad_username">
                            <span id="ad_username_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">PASSWORD</label>
                            <input type="password" name="ad_password" class="form-control" id="ad_password">
