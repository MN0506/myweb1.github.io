...
<!--                        <small>Examples of various form controls.</small>-->
         ...
         <?php
          ...
          ?>
                    ...
                    <form name="formID" id="formID" action="extra_charges_update.php" method="post" enctype="multipart/form-data" onsubmit="return ValidateForm()">
                        
                        <input type="hidden" id="ec_id" name="ec_id" value="<?php echo $row["ec_id"];?>"> 


                        <div class="form-group">
                            <label for="inputName1" class="control-label">CGST</label>
                            <input type="text" class="form-control" name="ec_cgst" id="ec_cgst" value="<?php echo $row["ec_cgst"];?>" >
                            <span id="ec_cgst_error"></span>
                        </div>
                        <div class="form-group">
                            <label for="inputName1" class="control-label">SGST</label>
                            <input type="text" class="form-control" name="ec_sgst" id="ec_sgst" value="<?php echo $row["ec_sgst"];?>" >
                            <span id="ec_sgst_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">MINIMUM AMOUNT</label>
                            <input type="text" class="form-control" name="ec_minimum_amount" id="ec_minimum_amount" value="<?php echo $row["ec_minimum_amount"];?>" >
                            <span id="ec_minimum_amount_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">DELIVERY CHARGES</label>
                            <input type="text" name="ec_delivery_charges" class="form-control" id="ec_delivery_charges" value="<?php echo $row["ec_delivery_charges"];?>" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ec_min_stock_qty" class="form-control" id="ec_min_stock_qty" value="<?php echo $row["ec_min_stock_qty"];?>" >
                            <span id="ec_min_stock_qty_error"></span>
                        </div>
                        
                        <div class="form-group">
                            <label for="inputEmail" class="control-label">MAXIMUM STOCK QUANTITY</label>
                            <input type="text" name="ec_max_stock_qty" class="form-control" id="ec_max_stock_qty" value="<?php echo $row["ec_max_stock_qty"];?>" >
