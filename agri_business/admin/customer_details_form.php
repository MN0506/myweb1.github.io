                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            <div class="hpanel">
                                ...
                                <div class="panel-body">
                    <form name="formID" id="formID" action="customer_details_insert.php" method="post" enctype="multipart/form-data" onsubmit="return ValidateForm()">

                        <div class="form-group">
                            <label for="inputName1" class="control-label">CUSTOMER NAME</label>
                            <input type="text" class="form-control" name="cd_name" id="cd_name">
                            <span id="cd_name_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">CUSTOMER ADDRESS</label>
                            <textarea name="cd_address"  id="cd_address" class="form-control"></textarea>
                            <span id="cd_address_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">CONTACT NO</label>
                            <input type="text" class="form-control" name="cd_contact" id="cd_contact">
                            <span id="cd_contact_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">EMAIL ID</label>
                            <input type="text" name="cd_email_id" class="form-control" id="cd_email_id">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="cd_username" class="form-control" id="cd_username">
                            <span id="cd_username_error"></span>
                        </div>

                        <div class="form-group">
                            <label for="inputEmail" class="control-label">PASSWORD</label>
                            <input type="text" name="cd_password" class="form-control" id="cd_password">
